export const MESSAGES = {
  ...
  SKILL: {
    FETCHED: 'Skills fetched successfully',
  ...
  EXPERIENCE: {
    FETCHED: 'Experience fetched successfully',
  ...
  PROJECT: {
    ...
    DETAIL_FETCHED: 'Project fetched successfully',
  ...
  BLOG: {
    ...
    DETAIL_FETCHED: 'Blog fetched successfully',
  ...
  NEWSLETTER: {
    ...
    ALREADY_EXISTS: 'Email is already subscribed',
  },
